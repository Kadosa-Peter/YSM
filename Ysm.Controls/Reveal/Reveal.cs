...
namespace Ysm.Controls
{
    public class Reveal : Decorator
    {
        ...
        public static readonly DependencyProperty EasingProperty = DependencyProperty.Register(
            "Easing", typeof(IEasingFunction), typeof(Reveal), new PropertyMetadata(default(IEasingFunction)));
        ...
        // Using a DependencyProperty as the backing store for IsExpanded.  This enables animation, styling, binding, etc/Ermirage.Controls;component.
        ...
        // Using a DependencyProperty as the backing store for Duration.  This enables animation, styling, binding, etc/Ermirage.Controls;component.
        public static readonly DependencyProperty DurationProperty =
            DependencyProperty.Register("Duration", typeof(double), typeof(Reveal), new UIPropertyMetadata(250.0));

        #endregion

        #region HorizontalReveal
        ...
        // Using a DependencyProperty as the backing store for HorizontalReveal.  This enables animation, styling, binding, etc/Ermirage.Controls;component.
        ...
        // Using a DependencyProperty as the backing store for VerticalReveal.  This enables animation, styling, binding, etc/Ermirage.Controls;component.
        ...
        // Using a DependencyProperty as the backing store for AnimationProgress.  This enables animation, styling, binding, etc/Ermirage.Controls;component.
