...
namespace Ysm.Views
{
    public partial class WatchLaterView
    {
        ...
        public WatchLaterView()
        {
            ...
            ViewRepository.Add(this, nameof(WatchLaterView));
            ...
            WatchLaterCache.Default.Added += Cache_Added;
            WatchLaterCache.Default.Removed += Cache_Removed;

            WatchLaterNodeMenu menu = new WatchLaterNodeMenu();
            NodeTree.ContextMenu = menu.Get();
        }

        private void WatchLaterView_OnLoaded(object sender, RoutedEventArgs e)
        {
            CreateList();
        }
        ...
        private void CreateList()
        {
            ...
            _playlist = Repository.Default.Playlists.Get("WatchLater");
        ...
        public void CreateRoot()
        {
            ...
            {
                Id = Identifier.Empty,
                Title = Properties.Resources.Title_WatchLater
            };
        ...
        public static Node CreateChannel(Channel channel, Node parent)
        {
            Node node = new Node
            {
                Channel = channel,
        ...
        {
            if (Kernel.Default.View != View.WatchLater) return;
            ...
            if (n == null)
            {
                Channel channel = Repository.Default.Channels.Get().FirstOrDefault(x => x.Id == channelId);
        ...
        {
            Debug.WriteLine(Search.IsSearch);
