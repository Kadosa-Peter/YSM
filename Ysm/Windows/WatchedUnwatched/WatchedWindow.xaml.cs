...
{
    public partial class WatchedWindow
    {
        ...
        private void WatchedWindow_OnKeyDown(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Escape)
                Close();
        }
        ...
        private void MarkWatched_OnClick(object sender, RoutedEventArgs e)
        {
            int day = int.Parse(Day.Text);
            day = day * -1;
            ...
            Task.Run(() => { Repository.Default.Videos.MarkWatched(dateTime); }).ContinueWith(t =>
            {
